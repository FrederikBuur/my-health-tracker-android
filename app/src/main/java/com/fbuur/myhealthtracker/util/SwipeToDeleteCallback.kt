...
abstract class SwipeToDeleteCallback(
    ...
    private var deleteIcon = context?.let { ContextCompat.getDrawable(it, R.drawable.ic_delete) }
...
//            this.deleteIcon = ContextCompat.getDrawable(recyclerView.context, R.drawable.ic_delete)
//        }
//
